...
const { getUsers, getUser, updateUser, deleteUser, toggle  } = require('../controllers/users.controller')
...
router.route('/update-address/:id').post(protect,authorize('admin','user'),updateUser)
